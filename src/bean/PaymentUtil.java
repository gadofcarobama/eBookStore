...
public class PaymentUtil {
	...
	public static String getUrl(String oid, String pd_FrpId) {
		// 准备提交的参数:
		...
		String p5_Pid = ""; // 商品名称
		String p6_Pcat = ""; // 商品种类
		String p7_Pdesc = ""; // 商户描述
		String p8_Url = "http://169.254.145.18/estore/order?method=callBack"; // 付款成功后跳转的页面
		String p9_SAF = ""; // 送货地址
		String pa_MP = ""; // 商户扩展信息
		String pr_NeedResponse = "1"; // 应答机制
		String keyValue = "69cl522AV6q613Ii4W6u8K6XuW8vM1N6bFgyv769220IuYe9u37N4y7rI4Pl"; // 秘钥
		String hmac = buildHmac(p0_Cmd, p1_MerId, p2_Order, p3_Amt,
